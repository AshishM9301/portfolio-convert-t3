...
import { validateSession } from "@/lib/admin/session-store";
...
/**
 * Protected (authenticated) procedure - Better Auth
 *
...
/**
 * Admin (passwordless) procedure
 *
 * This procedure uses the custom passwordless admin authentication system.
 * It validates JWT tokens against Redis sessions.
 */
export const adminProcedure = t.procedure.use(async ({ ctx, next }) => {
  ...
  const rateLimit = await rateLimiters.adminApi(token);
